...
<div class="page-header">
    <div class="page-header-left">
        ...
        <div>
            ...
            <p class="page-subtitle">Enregistrez une nouvelle livraison</p>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo APP_URL; ?>/bon-livraison">
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="reference" name="reference" placeholder="BL-2024-001" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Détails de la livraison..."></textarea>
            </div>
            <div class="d-flex gap-2 pt-3" style="border-top:1px solid var(--border-color);">
                <button type="submit" class="btn btn-primary">
                    <i data-lucide="check" style="width:16px;height:16px;"></i> Créer le bon
                </button>
